...
/**
 * App factory, separate from process bootstrap.
 *
 * server/src/index.js calls this and then app.listen() for local/VM use.
 * api/[...path].js (the Vercel serverless entry) imports this directly and
 * exports the Express app itself, since Express apps are callable as
 * (req, res) and that is exactly the handler signature Vercel's Node runtime
