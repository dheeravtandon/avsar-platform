...
PHASES = [
    ...
    ("P3", "Data model and workflow design", "Seventeen-table schema; declare every legal state transition in one module; design the eligibility gate so each check cites its rule.",
    ...
    ("P10", "Client - role workspaces", "Seven role-aware workspaces across thirty-one routes: authoring, discovery, scoring, pilot monitoring, procurement, payments, grievance, audit and administration.",
